...
import kotlinx.android.synthetic.main.activity_add.edtProductName
import kotlinx.android.synthetic.main.activity_add.edtProductPrice
...
class EditActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        edtProductName.setText(p.ProductName)
        edtProductPrice.setText(p.ProductPrice.toString())

        cmdEdit.setOnClickListener{
            p.ProductName = edtProductName.text.toString()
            p.ProductPrice = edtProductPrice.text.toString().toInt()
